export const HomeAbout = () => {
  return (
    <div className="bg-primaryBackground py-10 px-5 lg:px-0 lg:py-20">
      <div className="container mx-auto">
        <h6 className="text-secondary font-serif text-2xl text-center">
          About Us
        </h6>
        <h1 className="font-serif capitalize my-5 text-center text-6xl  ">
          Welcome to our <br /> Inner Circle
        </h1>
        <p className="text-black/60 max-w-3xl mx-auto text-center md:p-5 ">
